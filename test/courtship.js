...
exports['test the right courtier is selected'] = function (test) {
	...
	var parent = new Creature(1, {"Longevity" : [10, 5]}, [], 1000);
	var female = new Creature(1, {"Longevity" : [10, 5]}, [parent], 1000);
	var male = new Creature(0, {"Longevity" : [10, 5], "Prowess" : [3, 5]}, [parent], 1000);
	var alphamale = new Creature(0, {"Longevity" : [10, 5], "Prowess" : [10, 5]}, [parent], 1000);
